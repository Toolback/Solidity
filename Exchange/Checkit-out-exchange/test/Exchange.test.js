...
contract('Exchange', ([deployer, feeAccount, user1, user2]) => {
    ...
    describe('deployment', () => {
        it('tracks the fee Account', async () => {
            ...
            result.should.equal(feeAccount) // Check the token name is My Name
        })

        it('tracks the fee Percent', async () => {
            const result = await exchange.feePercent() // Read token name here ...
            result.toString().should.equal(feePercent.toString()) // Check the token name is My Name
        })
    ...
    describe('depositing Ether', async () => {
        ...
        it('emits a Deposit event', async () => {
            ...
            event.amount.toString().should.equal(amount.toString(), 'amout is correct')
    ...
    describe('depositing tockens', () => {
        ...
        describe('succes', () => {
            ...
            it('tracks the tockens deposit', async () => {
    ...
    describe('withdrawingtokens', async () => {
        let result 
        let amount 
    ...
    describe('order actions', async () => {
        ...
        describe('filling orders', async () => {
            ...
            describe('succes', async () => {
                ...
                it('executess the trade & charges fees', async () => {
                    let balance
